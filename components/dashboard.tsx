    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-50">
      ...
      <footer className="mt-auto py-8 px-6">
        <div className="container mx-auto">
          <div className="bg-gradient-to-r from-slate-50 to-gray-50 rounded-2xl p-6 border border-gray-200/60 shadow-sm">
            <div className="flex items-center justify-center space-x-4 text-base text-gray-700">
              <span className="font-medium">Powered by</span>
              <a 
                href="https://tekvolabs.com/" 
                target="_blank" 
                rel="noopener noreferrer"
                className="flex items-center space-x-3 hover:text-blue-600 transition-all duration-300 group bg-white rounded-full px-4 py-2 shadow-md hover:shadow-lg"
              >
                <img 
                  src="/tekvolabs-logo.png" 
                  alt="TekvoLabs" 
                ...
                />
                <span className="font-bold text-slate-800 group-hover:text-blue-600 text-lg">TekvoLabs</span>
              </a>
            </div>
            <div className="text-center mt-3">
              <p className="text-sm text-gray-500">Building innovative solutions for modern businesses</p>
            </div>
          </div>
        </div>
      </footer>
